...
def rcrack1(uid,pwx,tl):
    ...
    # 'cookie': 'datr=1dOWZfrvNa4mLui2MwL7vPra; sb=1dOWZf3-SrodoFKve2-EEVAl; vpd=v1%3B648x360x2; wl_cbv=v2%3Bclient_version%3A2390%3Btimestamp%3A1704612274; locale=bn_IN; dpr=2.1988937854766846; m_pixel_ratio=2; wd=360x648; fr=0k9Efs4JEbWjbcHwV.AWWvTUu8PffmneQ7Tx6gDayj3JA.BlltPV.xG.AAA.0.0.Blm2as.AWUgR5EHUN8',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.116"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"RMX3830"',
